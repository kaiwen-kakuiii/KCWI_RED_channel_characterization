...
these reductions use twilight flats, and requiring them was expensive because KOA
...
# Paths resolve against this file, not the shell's cwd.  The labelled table and
# the calib cache live next to the script.  Raw frames go in the repo's fits/.
HERE = os.path.dirname(os.path.abspath(__file__))
ROOT = os.path.dirname(HERE)
MATCHED_CSV = os.path.join(HERE, "outputKC", "std_red_matched.csv")
FITSDIR = os.path.join(ROOT, "fits")
...
# What these reductions actually consume: arc/tilt <- arclamp,
